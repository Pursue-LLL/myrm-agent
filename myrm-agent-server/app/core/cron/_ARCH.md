...
| `blueprints.py` | 核心 | 自动化蓝图单一数据源：18 个内置蓝图（en/zh 内联 + ja/de/ko 经 `blueprint_i18n_supplement.py` 合并；含 `seo_weekly_audit`、`wiki_maintain` 与 `wiki_vault_weekly_health` 等） | — |
