...
ContextBundle 卷布局见 Harness `myrm-agent-harness/src/myrm_agent_harness/toolkits/context/CONTEXT_BUNDLE_SYSTEM.md`。
...
- `myrm_agent_harness.toolkits.context` — bundle spec types (`IncognitoPolicy`, `AgentContextOverlay`)
