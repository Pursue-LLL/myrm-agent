...
| `history.py` | 模块 | 频道聊天历史持久化、标题生成；**入站新 turn 前 `run_pre_reply_stale_compact_gate`**；persist/resume 时 sync topic workspace | ✅ |
...
- `tests/core/channel_bridge/test_deliverable_deep_links.py`
