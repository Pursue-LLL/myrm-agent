...
| `helpers.py` | 模块 | Business-layer assembly for IM/channel turns headed to the SkillAgent runtime. StreamAccumulator tracks cost_usd, model_name, and total_tokens for channel budget attribution and cost metadata display. | ✅ |
