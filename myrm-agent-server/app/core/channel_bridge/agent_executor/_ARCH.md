...
| `executor.py` | 核心 | Executes Agent tasks for inbound channel messages with session-aware auto-reset notification. Registers `on_artifacts_ready` callback to bridge harness file artifacts into IM outbound media delivery. | ✅ |
