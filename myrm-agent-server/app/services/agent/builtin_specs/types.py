...
_TOOL_DATA_VIZ: tuple[str, ...] = _extend_default_tools("external_cli", "image_generation")
_TOOL_VIDEO_STUDIO: tuple[str, ...] = _extend_default_tools("video_generation", "tts", "image_generation", "kanban")
