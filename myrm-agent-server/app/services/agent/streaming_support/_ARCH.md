...
| 文件 | 地位 | 职责 | I/O/P |
|------|------|------|-------|
| `sse_helpers.py` | 核心 | SSE 格式化、审批/澄清/目录 HITL 超时调度（900s auto-resume）、压缩耗尽检测、错误 chunk 生成 | ✅ |
