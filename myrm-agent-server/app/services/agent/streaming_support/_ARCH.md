...
| `stream_collector_helpers.py` | 辅助 | `StreamContentCollector` 纯函数：tool 结果解析、HITL clarification/directoryRequest/planConfirm 持久化 payload 构建、string-keyed dict 规范化 | ✅ |
