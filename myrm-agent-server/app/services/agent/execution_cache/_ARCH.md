...
|------|------|------|
| `__init__.py` | 入口 | 公共导出 |
| `registry.py` | 核心 | acquire/release/refresh_unit/guard_turn/idle_evict；进程级 singleton |
...
测试：`tests/services/agent/execution_cache/`（registry 单测 + stream_pipeline 集成测 2msg1build）。
