...
def builtin_risk_rules() -> list[dict[str, str | int | bool]]:
    ...
    return [
        ...
        },
        {
            ...
            "pattern": r"(?i)(?:passport|护照).{0,12}[A-Z0-9]{7,10}\b",
            "severity": RiskSeverity.MEDIUM,
            "action": RiskAction.BLOCK,
            "category": RiskCategory.PERSONAL,
            "sort_order": 40,
        ...
        },
        {
            ...
            "pattern": r"(?i)(简历|履历|\bresume\b|\bcurriculum vitae\b|\bwork experience\b|\bemployment history\b|\beducation history\b|\bexpected salary\b)",
            "severity": RiskSeverity.MEDIUM,
            "action": RiskAction.BLOCK,
            "category": RiskCategory.PERSONAL,
            "sort_order": 70,
