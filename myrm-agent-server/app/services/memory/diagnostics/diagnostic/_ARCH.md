...
| `diagnostic_static_checks.py` | 辅助 | 静态检查构建器：relational store/memory path/vector index/knowledge graph/embedding provider/event ledger/health snapshot/deployment boundary 快照检查 | ✅ |
