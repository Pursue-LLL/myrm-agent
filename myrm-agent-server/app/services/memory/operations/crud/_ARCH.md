...
| `import_archive.py` | 核心 | 导出（JSON + Markdown ZIP）、归档、导入、回滚；竞品 dry-run 四车道；`resolve_competitor_import_source` 强制 adapter；`instruction_total_chars` / `providers_configured` | ✅ |
