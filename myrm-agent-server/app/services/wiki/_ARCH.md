...
Wiki 知识库服务层：Memory→Wiki 归档、vault 路径 SSOT、启动迁移、SessionNotes 后台归档。
...
- **Shared archiver**: `vault_service.get_wiki_archiver()` — API 与 SessionNotes 钩子共用
...
| `wiki_archive_hook.py` | 钩子 | SessionNotes 持久化后归档 | ✅ |
