...
class Agent(Base):
    ...
    default_security_preset: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ...
    trusted_desktop_apps: Mapped[list[dict[str, str]]] = mapped_column(JSON, default=list, nullable=False)
