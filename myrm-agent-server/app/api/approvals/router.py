...
async def _handle_knowledge_patch_resolution(record: ApprovalRecord, decision: str) -> None:
    """Delegate approved knowledge patch resolution to knowledge_patch module."""
