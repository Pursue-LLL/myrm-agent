...
router.include_router(
    retrieval.router, prefix="/retrieval", tags=["integrations-retrieval"]
)
...
router.include_router(
    im_contacts.router, prefix="/contacts", tags=["integrations-contacts"]
)
router.include_router(
    integration_memory.router, prefix="/memory", tags=["integrations-memory"]
)
