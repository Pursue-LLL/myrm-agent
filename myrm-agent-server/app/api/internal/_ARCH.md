...
| `org_managed_approval_policy_sync.py` | 模块 | CP-to-sandbox internal endpoint for syncing org managed approval policy (force auto-review / disable allow-always patterns); POST only, mirrors `org_model_policy_sync` | ✅ |
