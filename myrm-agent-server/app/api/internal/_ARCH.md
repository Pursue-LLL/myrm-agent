...
| `org_model_policy_sync.py` | 模块 | CP-to-sandbox internal endpoint for syncing org-level model policy (allowed patterns); frontend reads via GET for model selector filtering | ✅ |
