...
| 文件 | 职责 | I/O/P |
| --- | --- | --- |
| `router.py` | REST CRUD + save-from-run + `GET /trunk-catalog` + `POST /{id}/admit` (evidence/safety/prior gates, 422 reason codes); GET detail includes `bound_cron_count`; PUT upsert is import SSOT for Web UI JSON bundle | ✅ |
