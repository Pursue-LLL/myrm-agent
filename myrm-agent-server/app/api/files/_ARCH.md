...
| `revert.py` | 模块 | File revert & review API — message-level / session-level undo of AI file edits and review diffs. Hydrate/cleanup via `app/services/files/revert_hydrate.py`. | ✅ |
