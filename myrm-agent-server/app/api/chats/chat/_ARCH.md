...
| `core.py` | 模块 | 会话 CRUD 核心：列表（分页/来源/项目过滤）、元数据（GET 含 session_access_roots、activeMoaPresetId）、创建/更新、Fission 拓扑、session-skills PATCH、active-moa-preset PATCH、session-access-roots revoke PATCH；PATCH workspace 在 project 已绑定时 409 | ✅ |
