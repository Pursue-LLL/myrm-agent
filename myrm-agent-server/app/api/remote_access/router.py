...
async def tailscale_status() -> dict[str, object]:
    from app.remote_access.tailscale_service import probe_tailscale_status

    info = await probe_tailscale_status()
    return success_response(
        data={
