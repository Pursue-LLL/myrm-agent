...
def _to_agent_response(
    ...
    return AgentResponse(
        ...
        cost_reduction_ratio=float(metadata["cost_reduction_ratio"])
        if metadata.get("cost_reduction_ratio") is not None
        else None,
        ...
        trusted_desktop_apps=_meta_list_or_empty(metadata, "trusted_desktop_apps"),
