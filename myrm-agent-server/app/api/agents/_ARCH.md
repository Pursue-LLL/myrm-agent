...
| `openapi_services.py` | 模块 | OpenAPI Services API. Enables frontend to preview parsed specs and test connectivity before saving service configurations. """ | ✅ |
...
| `templates.py` | 模块 | Agent template catalog and factory. Reads YAML seeds from assets/prebuilt_agents/, exposes listing and one-click instantiation for both individual and team temp | ✅ |
