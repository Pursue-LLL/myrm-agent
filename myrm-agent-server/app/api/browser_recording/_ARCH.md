...
| POST | `/recording/generate-skill` | Generate Browser Skill from completed session (LLM description when omitted; template fallback otherwise; session released from the registry on success) |
