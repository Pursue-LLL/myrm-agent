...
| `router.py` | 路由 | REST：… **GET /stats** 含 `structural_issues`；`_invalidate_wiki_structural_stats_cache` 在 compile/maintain/repair-types/import/**apply/delete concept/delete folder/pending approve/delete raw** 成功后失效 TTL | ✅ |
