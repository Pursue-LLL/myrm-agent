...
- Catalog parity: test_active_tool_groups asserts gap registry keys match TOGGLABLE minus skill_market/skill_manage (no substring gap preflight for those toggles).
