...
| `imessage.py` | 模块 | iMessage channel via BlueBubbles API. Text/media send, Tapback reactions, typing indicator (Private API), webhook authentication, structured diagnostics. | ✅ |
