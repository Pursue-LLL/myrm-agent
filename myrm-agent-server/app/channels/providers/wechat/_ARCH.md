...
| `draft_service.py` | 模块 | HITL draft pipeline: inline images before thumb; draft content = body + embedded `<style>` (from formatter SSOT) + block inline styles; uploadimg + draft/add; inline failures fail-loud. | ✅ |
