...
| 文件 | 地位 | 职责 | I/O/P |
|------|------|------|-------|
| `en.ftl` | 数据 | 英文 Fluent 翻译（渠道命令回复、系统消息、WebUI 后台 bash 完成通知 `bash_bg_finish_*`、Agent picker 提示、预算拦截消息） | — |
| `zh-CN.ftl` | 数据 | 简体中文 Fluent 翻译（含 `bash_bg_finish_*` 后台 bash 完成通知） | — |
