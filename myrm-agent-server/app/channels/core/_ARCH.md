...
| bus.py | Core | Message routing hub. Producers call publish_outbound; IM channels persist via DurableOutboundGate before dispatch; retains disk obligation when channel disabled/stopped/unregistered; null-send guard; dispatch-idle durable recover; outbound risk gate before send. | ✅ |
