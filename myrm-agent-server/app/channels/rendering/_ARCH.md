...
| splitter.py | Core | Smart long-message splitter + `cap_stream_preview` for streaming IM placeholders. Fence state machine, CJK boundaries, join-preserving line iteration. | ✅ |
