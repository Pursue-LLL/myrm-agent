...
from app.services.agent.streaming_support.stream_collector_helpers import deep_merge_ui_data


class TestDeepMergeUiData:
    def test_merges_top_level_scalars(self) -> None:
        result = deep_merge_ui_data({"name": "", "age": 0}, {"name": "Alice", "age": 30})
        assert result == {"name": "Alice", "age": 30}

    def test_deep_merges_nested_dicts(self) -> None:
        result = deep_merge_ui_data(
