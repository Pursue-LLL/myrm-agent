...
class TestProjectWorkspaceE2E:
    ...
    def test_project_workspace_agent_routing(self, client: TestClient):
        # 1. Create a project
        project_resp = client.post("/api/v1/projects/", json={"name": "E2E Project Workspace"})
        ...
        client.post(f"/api/v1/chats/", json={"id": chat_id, "title": "E2E Chat"})
        client.patch(f"/api/v1/projects/chats/{chat_id}/project", json={"projectId": project_id})
