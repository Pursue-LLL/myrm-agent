...
@pytest.mark.asyncio
async def test_server_eval_executor_skill_ids_override(tmp_path):
    """skill_ids_override pins the skill set after profile resolution."""
    ...
    with patch(
        ...
        with patch("app.core.eval.executor.load_user_configs") as mock_configs:
            ...
            with patch(
                ...
                # None (default) keeps the profile's declared skills.
