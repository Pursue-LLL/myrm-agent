...
async def test_general_agent_content_normalization(client: TestClient):
    ...
    assert "hello" in full_message.lower() or "world" in full_message.lower() or "how are you" in full_message.lower() or "i am" in full_message.lower() or "doing" in full_message.lower()
