...
class TestUIArtifactCollection:
    ...
    def test_merges_data_update_into_existing_artifact(self, collector: StreamContentCollector) -> None:
        collector.feed_event(
            {
                "type": "ui_update",
                "subtype": "ui_artifact",
    ...
    def test_deep_merges_nested_data_update_without_wiping_sibling_fields(self, collector: StreamContentCollector) -> None:
        collector.feed_event(
            {
                "type": "ui_update",
                "subtype": "ui_artifact",
    ...
    def test_data_update_for_unknown_surface_id_is_ignored(self, collector: StreamContentCollector) -> None:
        collector.feed_event(
            {
                "type": "ui_update",
                "subtype": "data_update",
