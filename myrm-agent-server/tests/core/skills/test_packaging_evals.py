...
from myrm_agent_harness.agent.skills.packaging import EVALS_FILE, serialize_eval_cases
...
async def test_export_includes_evals_json(
    ...
    # evals.json 内容可还原
    from myrm_agent_harness.agent.skills.packaging import parse_evals_json
