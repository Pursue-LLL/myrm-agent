...
_ROUTER_MOUNTS: dict[str, _RouterMount] = {
    ...
    "agents_media": _RouterMount(
        "app.api.agents.media", prefix="/agents", tags=("agents",)
    ),
    ...
    "providers": _RouterMount("app.api.providers.balance_router", tags=("providers",)),
    ...
    "feishu_register": _RouterMount(
        "app.api.channels.feishu_register",
        prefix="/channels/manage",
        tags=("channels",),
    ),
