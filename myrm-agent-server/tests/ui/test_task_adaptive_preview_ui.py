...
async def test_task_adaptive_preview_ui_display():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            task_adaptive_elements = await page.query_selector_all("[data-testid*='task-adaptive'], [class*='task-adaptive'], [id*='task-adaptive']")
...
async def test_task_adaptive_preview_with_simulated_data():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            new_chat_button = await page.query_selector("[data-testid='new-chat'], button:has-text('New Chat'), button:has-text('新建对话')")
            if new_chat_button:
