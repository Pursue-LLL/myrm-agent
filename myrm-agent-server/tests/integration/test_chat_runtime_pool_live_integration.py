...
async def test_live_setup_reuses_registry_pool_and_wraps_facade() -> None:
    ...
    await mixin_a._do_setup_external_agents([], mount_invoke_acp_agent_tool=False)
...
async def test_live_fingerprint_replace_deferred_while_turn_locked() -> None:
    ...
    await mixin_c._do_setup_external_agents([], mount_invoke_acp_agent_tool=False)
...
async def test_live_general_agent_close_release_preserves_pool() -> None:
    ...
    await agent._do_setup_external_agents([], mount_invoke_acp_agent_tool=False)
    ...
    await agent2._do_setup_external_agents([], mount_invoke_acp_agent_tool=False)
