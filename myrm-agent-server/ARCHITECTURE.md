...
- **Ingress 需求 SSOT API**：`GET /api/v1/system/ingress-requirement` 基于 `channels/inbound_profile.py` 与 config store 汇总；前端 `useIngressRequirement` 单请求驱动渠道徽章与 System 条件展示 Tunnel / Public Ingress。
