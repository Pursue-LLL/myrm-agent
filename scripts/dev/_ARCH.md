...
| `subagent-dashboard-e2e-prepare.mjs` | 双平台 | P2c prepare：seed provider/YOLO、创建 chat、SSE delegate → JSON |
| `subagent-dashboard-e2e-verify.mjs` | 双平台 | P2c verify：REST cancel 探测 subagent 已停止 |
