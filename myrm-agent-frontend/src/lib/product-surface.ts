...
export const HIDDEN_BUILTIN_AGENT_IDS = new Set(['builtin-researcher', 'builtin-deep-search']);
...
export function resolveVisibleBuiltinAgentId(agentId: string | null | undefined, fallback = 'builtin-general'): string {
