...
export function formatRelativeDate(
  ...
  if (diffDays === 0) {
    return t('relativeDate.today');
  }
  if (diffDays === 1) {
    return t('relativeDate.yesterday');
  }
  if (diffDays < 7) {
    return t('relativeDate.daysAgo', { count: diffDays });
  }
  if (diffDays < 30) {
    return t('relativeDate.weeksAgo', { count: Math.floor(diffDays / 7) });
  }
  if (diffDays < 365) {
