      ...
      providers: [
        {
          ...
          routingProfile: 'anthropic',
          isBuiltIn: true,
          isEnabled: true,
          apiKeys: [{ id: 'k1', key: 'sk-ant-test', remark: '', isActive: true }],
          enabledModels: [],
          availableModels: [],
        },
      ],
      ...
      providers: [
        {
          ...
          isBuiltIn: true,
          isEnabled: true,
          apiKeys: [{ id: 'k1', key: 'sk-test', remark: '', isActive: true }],
          enabledModels: [],
          availableModels: [],
        },
      ],
      ...
      providers: [
        {
          ...
          isBuiltIn: true,
          isEnabled: true,
          apiKeys: [{ id: 'k1', key: '', remark: '', isActive: true }],
          enabledModels: [],
          availableModels: [],
        },
      ],
