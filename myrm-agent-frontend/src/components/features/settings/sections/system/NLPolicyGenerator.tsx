      ...
      {result && (
        <div className="rounded-lg border border-border bg-muted/30 p-3 sm:p-4 space-y-3 animate-in fade-in-0 slide-in-from-top-2 duration-200">
          ...
          {(() => {
            ...
            if (result.generated_config.permissions) {
              sections.push(t('sectionPermissions'));
            }
            if (result.generated_config.pathPolicy) {
              sections.push(t('sectionPathPolicy'));
            }
            if (result.generated_config.networkAllowlist) {
              sections.push(t('sectionNetwork'));
            }
            if (result.generated_config.privacyPolicy) {
              sections.push(t('sectionPrivacy'));
            }
