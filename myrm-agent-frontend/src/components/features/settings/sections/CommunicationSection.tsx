...
import ChannelRoutingSection from './ChannelRoutingSection';
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-muted-foreground">
          {activeTab === 'channels'
            ? '连接和启用外部即时通讯、邮箱、短信及企业服务消息通道 / Connect message delivery channels'
            : activeTab === 'routing'
              ? '设定不同频道、主题会话对应的智能体响应与上下文共享策略 / Map chats and channels to specific agents'
              : '配置语音转文字 (STT) 与文字转语音 (TTS) 底层服务商 / Setup speech and text audio capabilities'}
        </p>
      </div>
