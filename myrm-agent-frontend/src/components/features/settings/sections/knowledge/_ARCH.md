...
| `MigrationWizardSteps.tsx` | 核心 | 向导步骤 UI（ScanStep / PreviewStep / ResultStep）；Hermes cron skip 列表 + confirm cron 摘要；ResultStep Local Settings 路径展示 vault bind handoff；mount 时 silent recheck + readiness anchor | — |
