...
import { IconChevronDown, IconChevronUp } from '@/components/features/icons/PremiumIcons';
...
function formatRelativeTime(
  ...
  if (deltaSec < 3600) {
    return t('minutesAgo', { count: Math.floor(deltaSec / 60) });
  }
  if (deltaSec < 86400) {
    return t('hoursAgo', { count: Math.floor(deltaSec / 3600) });
  }
