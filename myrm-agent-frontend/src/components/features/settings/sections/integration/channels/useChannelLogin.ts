...
export type ChannelLoginPhase = 'idle' | 'starting' | 'waiting_qr' | 'scanned' | 'success' | 'failed' | 'cancelled';
 ...
 */
export function useChannelLogin(channelId: string, loginMethod: string, onSuccess?: () => void): UseChannelLoginReturn {
