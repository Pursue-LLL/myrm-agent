export const REQUIRED_RELAY_CAPABILITIES = [
  'navigate_url',
  'list_tabs',
  'attach_debugger',
  'detach_debugger',
...
export type RelayCapabilityStatusKind =
  | 'not_connected'
  | 'syncing'
  | 'ready'
  | 'upgrade_required';
...
export function buildRelayCapabilityRows(
...
export function listMissingRelayCapabilities(
  capabilities: readonly string[],
): RelayCapabilityKey[] {
  const capabilitySet = new Set(capabilities);
