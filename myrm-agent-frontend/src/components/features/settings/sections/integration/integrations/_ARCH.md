...
| `LifecycleWebhookSection.tsx`       | 生命周期出站 Webhook 管理卡片：端点 CRUD、Agent Profile 范围选择、事件多选（六国 i18n）、HMAC 徽标（`has_secret`）、`/{id}/ping` 探测；响应式 sm:flex 布局                                                                                                                                                  |
| `LifecycleWebhookSection.test.tsx`  | Webhook Section 渲染、Agent 选择、saved ping 交互测试                                                                                                                                                                                                                               |
