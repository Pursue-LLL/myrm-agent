/**
 * [INPUT] '@/components/primitives/switch'::Switch (POS: UI 基础组件)
 * [INPUT] '@/components/primitives/input'::Input (POS: UI 基础组件)
 * [INPUT] '@/components/primitives/label'::Label (POS: UI 基础组件)
 * [INPUT] '@/components/primitives/select'::Select (POS: UI 基础组件)
 * [INPUT] '@/components/primitives/skeleton'::Skeleton (POS: UI 基础组件)
