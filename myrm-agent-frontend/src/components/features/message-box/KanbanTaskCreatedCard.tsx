...
export const KanbanTaskCreatedCard = memo<KanbanTaskCreatedCardProps>(({ result, chatId }) => {
  ...
  return (
    <div className="mt-3 mb-1 w-full max-w-md overflow-hidden rounded-xl border border-border/60 bg-card text-card-foreground shadow-sm">
      ...
      <div className="flex items-center justify-end border-t border-border/40 bg-muted/20 px-4 py-2.5">
        <Button variant="ghost" size="sm" className="h-7 gap-1 text-xs" onClick={() => router.push(boardHref)}>
