/**
 * [OUTPUT]
 * - DoctorDashboard 专用 SVG 图标组件集合
 *
 * [POS]
 * 系统诊断面板图标库。DoctorDashboard 所需的全部 SVG 图标组件。
 */
...
export const XCircleIcon = ({ className = 'w-4 h-4' }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const ServerIcon = ({ className = 'w-4 h-4' }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const IdeaIcon = ({ className = 'w-4 h-4' }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const ClipboardCopyIcon = ({ className = 'w-4 h-4' }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
