...
| `ChatHistoryRow.tsx` | 核心 | 单行会话条目：右键菜单（Pin/Fork/Handoff/Automation/MoveToProject/Rename/Export/Delete） | ✅ |
...
| `useChatActions.ts` | Hook | 会话 Pin/Rename/Delete/Export 等 imperative 动作 | ✅ |
