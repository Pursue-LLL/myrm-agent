...
export const UITimePicker: React.FC<UIComponentProps> = ({
  props,
  bindings,
  data,
  onDataChange,
  ...
  const minTime = (props.minTime as string) || '';
  const maxTime = (props.maxTime as string) || '';
  const step = (props.step as number) || 60; // 步进秒数，默认 60 秒（1分钟）
