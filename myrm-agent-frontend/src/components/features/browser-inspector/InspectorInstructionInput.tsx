...
interface InspectorInstructionInputProps {
...
const InspectorInstructionInput: React.FC<InspectorInstructionInputProps> = ({
  selectedRefId,
  selectedInfo,
  instructionText,
  onInstructionChange,
...
export default React.memo(InspectorInstructionInput);
