...
export function GoogleOAuthIcon({ className }: IconProps) {
  return (
...
export function GitHubOAuthIcon({ className }: IconProps) {
  return (
...
export function OAuthProviderIcon({ provider, className }: { provider: string; className?: string }) {
  if (provider === 'google') {
    return <GoogleOAuthIcon className={className} />;
  }
  if (provider === 'github') {
    return <GitHubOAuthIcon className={className} />;
  }
  return <SsoOAuthIcon className={className} />;
}
