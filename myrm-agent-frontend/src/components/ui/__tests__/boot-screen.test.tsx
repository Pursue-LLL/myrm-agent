...
import BootScreen, { shouldShowBootScreen, markBootScreenShown } from '../boot-screen';
...
describe('BootScreen component', () => {
  ...
  it('styles last step as primary and shows pulse on current step', () => {
    ...
    expect(screen.getByText('step.ready').parentElement).toHaveClass('text-primary', 'font-medium');
  });
