...
import { type AgentThemeColor, AGENT_COLOR_CLASSES } from '@/components/ui/message-box/progress-steps/toolIcons';
...
const SkillsSection = dynamic(() => import('@/components/ui/settings/sections/SkillsSection'), {
  ssr: false,
});
const MCPSection = dynamic(() => import('@/components/ui/settings/sections/MCPSection'), {
  ssr: false,
});
