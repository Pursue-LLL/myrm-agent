 ...
 * @/components/ui/task-card::ImageTaskCard (POS: Async image-generation task card)
 *
 * [OUTPUT]
...
import ArtifactsDisplay from '@/components/ui/artifacts/ArtifactsDisplay';
import { InteractiveUIDisplay } from '@/components/ui/interactive-ui';
import ArtifactErrorBoundary from '@/components/ui/artifacts/ArtifactErrorBoundary';
import { UIActionEvent } from '@/store/chat/types';
import { formatUIActionAsMessage } from '@/components/ui/interactive-ui/utils';
...
import { CLIDiffViewer } from '@/components/ui/cli-visualization';
import { isTauriEnvironment } from '@/lib/tauri';
import { ImageTaskCard } from '@/components/ui/task-card';
