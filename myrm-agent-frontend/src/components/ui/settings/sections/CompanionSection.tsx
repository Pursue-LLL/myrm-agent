...
import {
  ...
  RARITIES,
  SPECIES,
} from '@/components/ui/companion/companionGenerator';
import { apiRequest } from '@/lib/api';
import useAuthStore from '@/store/useAuthStore';
import useCompanionStore from '@/store/useCompanionStore';

import { IconStar, IconConfetti, IconSparkle } from '@/components/ui/icons/PremiumIcons';
import SettingsSection from './SettingsSection';

import type { Hat, Rarity, Species } from '@/components/ui/companion/companionGenerator';
