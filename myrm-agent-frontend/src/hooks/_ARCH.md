...
| `useBrowserTakeoverActions.ts` | 浏览器 HITL Complete/Skip；Done/Skip 经 `resolveBrowserTakeoverMessageId()` 解析 messageId 后 sendMessage resume | Extension 横幅 + VNC 面板共用 |
